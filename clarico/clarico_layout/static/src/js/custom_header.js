$(document).ready(function(){ 
	if ($(window).width() > 1200) {
		...
		$('.first-level-left-div').mouseenter(function(){
			var self =$(this) 
			//var first_div = $(self).find('.first-level-left-div');
			$('.toggel_div').find('.menu_1_div').css("display","none");
			$('.toggel_div').css("display","none");
			$('.first-level-left-div').removeClass("active-li");
			$(this).addClass("active-li");
			$(this).siblings('.toggel_div').css("display","block");
			$(this).siblings('.toggel_div').find('.menu_1_div').css("display","block");
		});
		
		
		$('.first-level-left-div').mouseleave(function(){
			var self =$(this)
			var first_div = $(self).find('.first-level-left-div')
			self.removeClass("active-li");
			self.next('.toggel_div').find('.menu_1_div').css("display","none");
			self.next('.toggel_div').css("display","none");
		});
