...
#        print"generate_xlsx_report called record: ",record
        ...
        if record:
            ...
            if record.group_by and record.group_by=='category':
    ...
    #            # Content section
                ...
                filters, account_lines = record.get_report_datas_wg()
    #            # Filter section
                self.prepare_report_filters(filters)
    #            # Content section
                self.prepare_report_contents_wg(data, account_lines, filters)
