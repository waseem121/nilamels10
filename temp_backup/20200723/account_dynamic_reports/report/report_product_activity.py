...
class ProductActivity(models.AbstractModel):
    _name = 'report.account_dynamic_reports.product_activity'
...
#                print"docargs0000 ",docargs
                return self.env['report'].render('account_dynamic_reports.product_activity', docargs)
