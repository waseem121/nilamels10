...
class product_product(models.Model):
    ...
    def _compute_quantities_dict(self, lot_id, owner_id, package_id, from_date=False, to_date=False):
        ...
        for product in self.with_context(prefetch_fields=False):
            ...
            draft_inv_qty = self.get_draft_invoice_qty(product)
    ...
    def get_draft_invoice_qty(self,  product):
        self._cr.execute("select sum(l.quantity) from account_invoice_line l, account_invoice a where l.invoice_id=a.id "\
