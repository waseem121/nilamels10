...
#        print"amt: ",amount
    ...
    def process_filters(self):
        ...
        filters['partner_type'] = data.get('partner_type', 'Customers Only')
        filters['draft_invoices_refunds'] = data.get('draft_invoices_refunds', True)
        filters['show_zero_balance'] = data.get('show_zero_balance', True)
...
#                    print"period_dict[period]['name']11: ",period_dict[period]['name']
                ...
                # rouding to 3
                partner_dict[partner.id]['amount_due'] = float(round(partner_dict[partner.id]['amount_due'], 3))
