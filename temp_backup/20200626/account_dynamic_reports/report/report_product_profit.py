...
class ProductProfit(models.AbstractModel):
    _name = 'report.account_dynamic_reports.product_profit'
    ...
    def render_html(self, docids, data=None):
        ...
        if self.env.context.get('from_js'):
            if data.get('js_data'):
                ...
                return self.env['report'].render('account_dynamic_reports.product_profit', docargs)
