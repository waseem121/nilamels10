...
class AccountAccount(models.Model):
    ...
    group_account = fields.Boolean(string='Group Account in Reports')
#    main_view_account = fields.Boolean(string='Main View Account', help="used in Trial balance dynamic report for sorting accounts.")
