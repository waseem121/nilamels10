...
#        print"filtererrrrr ",filter
        ...
        if filter:
            ...
            self.sheet_2.write_string(self.row_pos_2, 0, _('Product'),
                                    self.format_header)
            product_list = ', '.join([ c or '' for c in filter['product_list_new']])
            self.sheet_2.write_string(self.row_pos_2, 1, (str(product_list) or ''), self.line_header_light)
            ...
            self.row_pos_2 += 1
            self.sheet_2.write_string(self.row_pos_2, 0, _('Vendor'),
                                    self.format_header)
            self.sheet_2.write_string(self.row_pos_2, 1, (str(filter['partner']) or ''), 
                            self.line_header_light)
                            
            self.row_pos_2 += 1
            self.sheet_2.write_string(self.row_pos_2, 0, _('Brand'),
                                    self.format_header)
            self.sheet_2.write_string(self.row_pos_2, 1, (str(filter['brand']) or ''), 
                                    self.line_header_light)
