...
class ProductProfitReport(models.TransientModel):
    ...
    show_products = fields.Boolean(string='Show Arabic Name',readonly=True)
    ...
    product_code = fields.Boolean(string='Product Code', default='True')
    product_name = fields.Boolean(string='Product Name', default='True')
    barcode_field = fields.Boolean(string='Barcode Field', default='True')
    quantity = fields.Boolean(string='Quantity', default='True')
    unit = fields.Boolean(string='Unit', default='True')
...
#            all_products.append(one_product_id)
        ...
        for categ in all_categ:
            ...
            for each_product in all_products:
                ...
                standard_price = each_product.qty_available
                
                v['balance'] = balance
                v['balance_value'] = balance * standard_price
                v['last_price'] = each_product.lst_price
                v['last_cost'] = standard_price
