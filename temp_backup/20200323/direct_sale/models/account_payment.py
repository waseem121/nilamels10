...
#            rec.write({'state': 'posted', 'move_name': move.name})
    ...
    def _create_payment_entry(self, amount):
        print"_create_payment_entry amount: ",amount
        ...
        if self.partner_type == 'supplier':
            if self.company_id and self.company_id.currency_id.id:
                if self.currency_id.id != self.company_id.currency_id.id:
                    ...
                    print"new_local_amount: ",new_local_amount
...
#                    print"amount_currency: ",amount_currency
        ...
        print"destination_account_id: ",self.destination_account_id
        print"counterpart_aml_dict: ",counterpart_aml_dict
#        stop
        counterpart_aml = aml_obj.create(counterpart_aml_dict)
        print"after counterpart_aml"
        
        print"payment_difference: ",self.payment_difference
