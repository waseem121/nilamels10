...
#    update account_invoice set exchange_rate = 1 where exchange_rate is null;
#    update account_invoice_line set commission_share=0 where commission_share is null;
#    update account_invoice_line set discount_share=0 where discount_share is null;
