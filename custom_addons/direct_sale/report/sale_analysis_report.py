        ...
        select_str = """
            WITH currency_rate as (%s)
             SELECT min(l.id) as id,
                    ...
                    SUM(CASE WHEN s.type = 'out_invoice' THEN (l.price_subtotal_signed-l.total_discount_amount) ELSE (l.price_subtotal_signed-l.total_discount_amount) * 1 END) as price_subtotal,

                    SUM(CASE WHEN s.type = 'out_invoice' THEN l.total_discount_amount ELSE l.total_discount_amount * -1 END) as discount,
                    SUM(CASE WHEN s.type = 'out_invoice' THEN l.commission_share ELSE l.commission_share * -1 END) as commission,
                    ...
                    SUM(CASE WHEN s.type = 'out_invoice' THEN ((l.price_subtotal_signed-l.total_discount_amount-l.commission_share) - ((l.quantity+l.free_qty) * l.cost_price)) ELSE (((l.price_subtotal_signed*-1)-l.total_discount_amount-l.commission_share) - ((l.quantity+l.free_qty) * l.cost_price)) * -1 END) as profit,
