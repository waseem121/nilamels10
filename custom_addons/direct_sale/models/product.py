...
class product_product(models.Model):
    ...
    def _compute_quantities_dict(self, lot_id, owner_id, package_id, from_date=False, to_date=False):
        ...
        for product in self.with_context(prefetch_fields=False):
            ...
            print"draft_inv_qty: ",draft_inv_qty
...
#            return 0.0
    ...
    def get_draft_invoice_qty_old(self,  product):
        self._cr.execute("select sum(l.quantity+l.free_qty) from account_invoice_line l, account_invoice a where l.invoice_id=a.id "\
            "and a.state in ('draft','proforma','proforma2') and a.type in ('out_invoice', 'out_refund') and l.product_id=%s",(product.id,))
