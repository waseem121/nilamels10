...
#                        valuation_price_unit = i_line.purchase_line_id.product_uom._compute_price(i_line.purchase_line_id.price_unit, i_line.uom_id)
                        valuation_price_unit = i_line.purchase_line_id.price_subtotal / (i_line.purchase_line_id.product_qty + i_line.purchase_line_id.free_qty)
...
#                            print"valuation_price_unit in else: ",valuation_price_unit
                    ...
                    new_price_unit = i_line.price_subtotal / (i_line.quantity + i_line.free_qty)
                    if inv.currency_id.id != company_currency.id:
                    ...
                    if round(valuation_price_unit, 3) != round(new_price_unit,3):
                        ...
                        valuation_price_unit = purchase_line.price_subtotal / ((purchase_line.product_qty + purchase_line.free_qty) * (purchase_line.product_uom.factor_inv))
