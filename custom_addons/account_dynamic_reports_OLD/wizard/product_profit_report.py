...
#                for l in invoice_lines:
                for l in invoice_line_ids:
                    ...
                    if l.invoice_id and l.invoice_id.type == 'out_refund':
                        ...
                        this_commission_share = l.commission_share or 0.0
...
#                        this_price = l.price_subtotal - l.discount_share - l.commission_share
                        this_price = (l.price_subtotal / exchange_rate) - this_discount_share - this_commission_share
                        this_cost = l.cost_price * (l.quantity + l.free_qty)
#                        if not show_bonus_and_bonus_cost:
#                            this_cost = l.cost_price * (l.quantity + l.free_qty)
#                        else:
#                            this_cost = l.cost_price * l.quantity
...
#                for l in invoice_lines:
                for l in invoice_line_ids:
                    ...
                    if l.product_id.id != each_product.id:
                        continue
                    if l.invoice_id and l.invoice_id.type == 'out_refund':
                        this_discount_share = l.discount_share or 0.0
                        if this_discount_share:
                            this_discount_share = this_discount_share / exchange_rate
                        this_commission_share = l.commission_share or 0.0
                        if this_commission_share:
