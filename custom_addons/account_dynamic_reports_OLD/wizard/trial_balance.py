...
#                account = self.account_ids[0]
#                move_lines = {x.code: {'name':x.name,'code':x.code,'id':x.id,
#                                     'initial_debit':0.0, 'initial_credit':0.0,'initial_balance':0.0,
#                                     'debit':0.0, 'credit':0.0, 'balance':0.0,
#                                     'ending_credit':0.0, 'ending_debit':0.0, 'ending_balance':0.0,
#                                     'company_currency_id': company_currency_id.id} for x in self.account_ids} # base for accounts to display
#                                 
#                move_lines[account.code]['debit'] = total_deb
#                move_lines[account.code]['credit'] = total_cre
#                move_lines[account.code]['balance'] = total_bln
#                
#                move_lines[account.code]['initial_balance'] = total_init_bal
#                move_lines[account.code]['initial_credit'] = total_init_cre
#                move_lines[account.code]['initial_debit'] = total_init_deb                
#                
#                move_lines[account.code]['ending_balance'] = total_end_bal
#                move_lines[account.code]['ending_credit'] = total_end_cre
#                move_lines[account.code]['ending_debit'] = total_end_deb
