    ...
    def _onchange_discount_type(self):
        ...
        if self.discount_type == 'amount':
            if len(self.order_line):
                line_data = []
		total_discount_share = 0.0
                discount_amount = self.discount_amount
                len_order_line = len(self.order_line)
                count = 0
		    ...
		    count += 1
                    ...
                    if (count == len_order_line) and (discount_amount != total_discount_share):
                        diff = discount_amount - total_discount_share
                        discount_share = discount_share + diff
...
class PurchaseOrderLine(models.Model):
    ...
    discount_share = fields.Float(string='Share Discount', digits=dp.get_precision('Discount'))
